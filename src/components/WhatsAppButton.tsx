...
const WHATSAPP_NUMBER = '5491133681890';
const MESSAGE = 'Hola, quiero consultar por un turno';
...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-rosa-coral text-blanco shadow-lg transition-all duration-300 hover:scale-110 hover:bg-rosa-coral/90 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rosa-coral focus-visible:ring-offset-2"
    >
