    ...
    <footer className="bg-blanco-calido border-t border-rosa-empolvado py-12">
      <div className="container mx-auto px-6">
        <div className="text-center">
          ...
          <p className="text-gris-oscuro font-light mb-6">
          ...
          <a 
            ...
            className="inline-flex items-center text-rosa-coral hover:text-rosa-coral/80 transition-colors font-light mb-8"
          >
