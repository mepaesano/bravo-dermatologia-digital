        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex">
                <Phone className="w-5 h-5 text-blue-300 mr-3 shrink-0" />
                <a href="tel:+541147912345" className="hover:text-blue-300 transition-colors">
                  +54 11 4791-2345
                </a>
              </li>
              <li className="flex">
                <Mail className="w-5 h-5 text-blue-300 mr-3 shrink-0" />
                <a href="mailto:consultas@dradanielabravo.com" className="hover:text-blue-300 transition-colors">
          ...
          <div>
            ...
            <div className="mt-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:from-blue-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg"
              >
                Reservar Turno
              </a>
            </div>
